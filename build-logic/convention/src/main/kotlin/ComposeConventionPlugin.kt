 ...
 * module it does not compile, and a third-party type nobody here can annotate (ADR-0029).
 ...
 * (ADR-0029). Off by default — it is diagnostic output, and generating it on every build would
